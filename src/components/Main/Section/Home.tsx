...
const Section = () => {
  return (
    <section id="home" className="pt-40 pb-32 text-center">
      ...
      <h3 className="text-2xl text-shadow-default font-bold text-orange mt-4 flex justify-center flex-wrap italic">
        <span>Pioneer of technology and</span> 
        <span>environmental equipment</span>
      </h3>
      <h4 className="mt-6 text-primary font-bold text-xl">弊社は環境に優しい設備、経済的な企業運営をサポートするエンジニア企業です</h4>
